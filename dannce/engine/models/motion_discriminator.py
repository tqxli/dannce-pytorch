...
def adv_disc_loss(real_disc_value, fake_disc_value):
...
if __name__ == "__main__":
    ...
    # inputs = torch.randn(2, 16, 66)

    # outputs = model(inputs)
    # print(outputs.shape)
    model = TemporalEncoder(66, 1, 2048, add_linear=True)
    inputs = torch.randn(1, 4, 66)
    outputs = model(inputs)
