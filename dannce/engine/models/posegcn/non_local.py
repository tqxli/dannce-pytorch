...
class GraphNonLocalLayer(_NonLocalBlock):
    def __init__(self, in_channels, inter_channels=None, sub_sample=1, bn_layer=True):
        super(GraphNonLocalLayer, self).__init__(in_channels, inter_channels=inter_channels, dimension=1,
...
class _GraphNonLocal(nn.Module):
    def __init__(self, hid_dim, grouped_order, restored_order, group_size):
        ...
        self.nl = GraphNonLocalLayer(hid_dim, sub_sample=group_size)
